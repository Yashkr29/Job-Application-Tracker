    ...
    <AuthFrame title="Create your account" subtitle="Start organizing applications, follow-ups, interviews, and resumes.">
      <form className="space-y-4" onSubmit={handleSubmit((values) => mutation.mutate(values))}>
        <label className="block text-sm font-medium text-text">
          Full name
          <Input className="mt-2 h-12 bg-muted/70" placeholder="Enter full name" {...register("name")} />
        </label>
        <label className="block text-sm font-medium text-text">
          Email
        ...
        <label className="block text-sm font-medium text-text">
          Password
          <Input className="mt-2 h-12 bg-muted/70" placeholder="Create password" type="password" {...register("password")} />
        </label>
